    ...
    <section className="py-20 bg-slate-50 border-b border-slate-200 relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
          ...
          {/* Card Dores */}
          <div className="bg-white rounded-xl p-6 sm:p-8 border border-slate-200/80 shadow-sm">
          ...
          <div className="bg-slate-900 rounded-xl p-6 sm:p-8 border border-slate-800 shadow-md relative overflow-hidden">
