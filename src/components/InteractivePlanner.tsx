  ...
  return (
    <section id="simulador" className="py-20 bg-slate-900 border-b border-slate-950 relative">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <ScrollReveal variant="scale" duration={0.9} delay={0.1}>
              ...
              <div className="lg:col-span-5 bg-slate-900 border border-slate-800/80 p-6 rounded-xl flex flex-col justify-between space-y-6">
                ...
                <div className="pt-2">
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 bg-whatsapp hover:bg-whatsapp-heavy text-white font-extrabold text-xs uppercase px-5 py-4 rounded-xl transition-all shadow-[0_4px_15px_rgba(37,211,102,0.15)] hover:shadow-[0_4px_25px_rgba(37,211,102,0.35)] cursor-pointer tracking-wider whitespace-nowrap group"
                  >
